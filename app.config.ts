...
const rawBundleId = "space.manus.FitSnapApp.t20260327062344";
const bundleId =
  rawBundleId
...
const env = {
  ...
  logoUrl: "https://d2xsxph8kpxj0f.cloudfront.net/310519663402898195/PzSmaERSUaBTGqiNUves7W/icon-ixS2UwGPHZseTUZQGrje9h.webp",
...
const config: ExpoConfig = {
  ...
  description: "AI-powered diet tracker for gym users. Take photos of meals, analyze nutrition with AI, and track daily intake with fitness-focused feedback.",
